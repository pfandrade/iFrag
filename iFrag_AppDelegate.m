...
#import "iFrag_AppDelegate.h"

@implementation iFrag_AppDelegate


/**
    Returns the support folder for the application, used to store the Core Data
    store file.  This code uses a folder named "iFrag" for
...
- (NSString *)applicationSupportFolder {
    ...
    return [basePath stringByAppendingPathComponent:@"iFrag"];
}
